...
export const BACKEND_PREDICTIONS_ENDPOINT = '/api/predictions';
export const DIRECT_ML_FALLBACK_ENDPOINT = 'https://digital-twin-rul-api-dm9i.onrender.com/predictions';

export const API_ENDPOINT = BACKEND_PREDICTIONS_ENDPOINT;
...
export class ApiDataManager {
  ...
  async fetchPredictions() {
    ...
    try {
      ...
      try {
        response = await fetch(DIRECT_ML_FALLBACK_ENDPOINT, {
          method: 'GET',
          headers: { 'Accept': 'application/json' },
          signal: AbortSignal.timeout(6000)
        });
        ...
        console.warn('⚠️ [ApiDataManager] Telemetry fetch failed on primary and fallback:', primaryErr.message);
        this.connectionState = 'ERROR';
        this.errorMessage = primaryErr.message;
